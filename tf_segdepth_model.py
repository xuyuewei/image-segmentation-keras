...
def segdepth(img_shape = (480,160),
             loss = [tf_seg_stereo_loss.categorical_dice,tf_seg_stereo_loss.regression_square_absolute],
             optimizer='adam',
    ...
    dep_outputs = layers.Conv2D(3, (1, 1), activation='softmax')(u_spp1)
